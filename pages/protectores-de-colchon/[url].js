...
export default function Protectores({ categories, subCategories }) {
    ...
    return (
        <BasicLayout className="Protectores" categories={categories} subCategories={subCategories} >
            <Seo title="Protectores" />

...
export default function Sabanas({ categories, subCategories }) {
    ...
    useEffect(() => {
        (async () => {
            const response = await getProductsHomeCategoryApi("sabanas",limirPerPage,getStartItem());;
    ...
    useEffect(() => {
        (async () => {
            const response = await getTotalProductsCategories("sabanas")
